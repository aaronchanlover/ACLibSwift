...
/*
 * ACTabBarItemBadgeView
 * 这个类定义了item中使用的badge视图样式，默认为ACTabBarItemBadgeView类对象。
 * 你可以设置ACTabBarItemContentView的badgeView属性为自定义的ACTabBarItemBadgeView子类，这样就可以轻松实现 自定义通知样式了。
 */
open class ACTabBarItemBadgeView: UIView {
